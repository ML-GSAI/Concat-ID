...
class Rotary3DPositionEmbeddingMixin(BaseMixin):
    def __init__(
        ...
        self.freqs_sin = freqs_sin.cuda()
        self.freqs_cos = freqs_cos.cuda()
...
class DiffusionTransformer(BaseModel):
    ...
    def _build_modules(self, module_configs):
        ...
        self.add_mixin(
            ...
            instantiate_from_config(
                ...
                compressed_num_frames=(self.num_frames - 1) // self.time_compressed_rate + 1 + 5,
    ...
    def forward(self, x, timesteps=None, context=None, y=None, **kwargs):
        ...
        context_images = kwargs["context_image"]
        assert context_images != None, "must specify context_images"
        x = torch.cat([x, context_images], dim=1)
        b, t, d, h, w = x.shape
        ...
        assert context_images.shape[1] <= 3

        return output[: , : -context_images.shape[1],...]
